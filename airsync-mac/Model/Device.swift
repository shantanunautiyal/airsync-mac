...
struct Device: Codable, Hashable, Identifiable {
    ...
    private enum CodingKeys: String, CodingKey {
        case name, ipAddress, port, adbPort
    }
}
...
struct MockData{
    ...
    static let sampleDevices = [
        Device(name: "Test Device 1", ipAddress: "192.168.1.101", port: 8080, adbPort: 5555),
        Device(name: "Test Device 2", ipAddress: "192.168.1.102", port: 8080, adbPort: 5555),
        Device(name: "Test Device 3", ipAddress: "192.168.1.103", port: 8080, adbPort: 5555)
    ]
}
